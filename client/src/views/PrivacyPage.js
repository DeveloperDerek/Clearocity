...
const PrivacyPage = () => {
    return(
        ...
        <div className="policies">
            ...
            <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from Clearocity.com (the “Site”).</p>
            ...
            <p>CONTACT US</p>
            <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at support@clearocity@gmail.com or by mail using the details provided below:</p>

            <p>Clearocity L.L.C</p>
        </div>
        <Newsletter />
        <Footer />
        </>
